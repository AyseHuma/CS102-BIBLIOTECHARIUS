...
public class BookSubcategoryPage {
    private final ClientTester app;

    public BookSubcategoryPage(ClientTester app) {
        this.app = app;
    }
    ...
    public void show(Stage stage) {
        ...
        Button top100Movies = new Button("Most Popular 100 BOOKS");
        Button top250Movies = new Button("Most Popular 250 BOOKS");
        Button top100Series = new Button("Most Popular 100 BOOKS");
        Button top250Series = new Button("Most Popular 250 BOOKS");
        Button backButton = new Button("Back");

        style(top100Movies, top250Movies, top100Series, top250Series, backButton);

        top100Movies.setOnAction(e -> {
            app.setLastChosenSubcategory("Top_100_Books");
            app.showComponentChoicePage("BOOK", "Top_100_Books");
        });

        top250Movies.setOnAction(e -> {
            app.setLastChosenSubcategory("Top_250_Books");
            app.showComponentChoicePage("BOOK", "Top_250_Books");
        });
