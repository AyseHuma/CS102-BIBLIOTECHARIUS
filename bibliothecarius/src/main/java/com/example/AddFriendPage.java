...
public class AddFriendPage extends Application {
    ...
    private void sendFriendRequest() {
        ...
        {
            requestStatusLabel.setText("Please enter a name.");
            return;
        }

        try
        {
            int result = AccountDb.sendFriendRequest(currentUserId, friendName);
            switch (result) {
    ...
    private void acceptSelectedRequest(Label statusLabel)
    {
    ...
    private void rejectSelectedRequest(Label statusLabel) {
        String selectedUsername = requestListView.getSelectionModel().getSelectedItem();
        if (selectedUsername == null)
        {
            statusLabel.setText("Select a request first.");
    ...
    private void removeSelectedFriend(Label statusLabel) {
    ...
    private void refreshRequestsAndFriends() {
        try
        {
